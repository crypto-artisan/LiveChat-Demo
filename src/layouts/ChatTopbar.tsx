...
import { faEnvelope, faCircleQuestion, faHandshake } from '@fortawesome/free-solid-svg-icons';
...
const ChatTopbar = ({
  ...
  return (
    <React.Fragment>
      <div className="d-flex align-items-center gap-1 chatbar" style={{ marginTop: "50px" }}>
        <div className="d-flex flex-col chatbar-item">
          <FontAwesomeIcon icon={faEnvelope} size="xl" color="blue" />
          <h2 className="chatbar-item-text">MESSAGES</h2>
        </div>
        <div className="d-flex flex-col chatbar-item">
          <FontAwesomeIcon icon={faCircleQuestion} size="xl" color="blue" />
          <h2 className="chatbar-item-text">HOW TELEDENTAL WORKS?</h2>
        </div>
        <div className="d-flex flex-col chatbar-item">
          <FontAwesomeIcon icon={faHandshake} size="xl" color="blue" />
          <h2 className="chatbar-item-text">MY APPOINTMENTS</h2>
        </div>
      </div>
    </React.Fragment>
  );
